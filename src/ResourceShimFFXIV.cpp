...
bool ResourceShimFFXIV::Init() {
    return GameHookT<sig_ffxiv_textures_recreate>::Hook(&org_ffxiv_textures_recreate, detour_ffxiv_textures_recreate, ffxiv_textures_recreate) &&
...
bool ResourceShimFFXIV::OnCreateResource(reshade::api::device* device,
...
void ResourceShimFFXIV::OnInitResource(reshade::api::device* device,
                                       const reshade::api::resource_desc& desc,
                                       const reshade::api::subresource_data* initData,
                                       reshade::api::resource_usage usage,
                                       reshade::api::resource handle) {}

bool ResourceShimFFXIV::OnCreateResourceView(reshade::api::device* device,

...
bool ConstantHandlerBase::UpdateConstantBufferEntries(command_list* cmd_list,
                                                      CommandListDataContainer& cmdData,
...
bool ConstantHandlerBase::UpdateConstantEntries(command_list* cmd_list,
                                                CommandListDataContainer& cmdData,
                                                DeviceDataContainer& devData,
                                                ToggleGroup* group,
                                                uint32_t index) {
...
void ConstantHandlerBase::UpdateConstants(command_list* cmd_list) {
    ...
    if (deviceData.current_runtime == nullptr ||
        (commandListData.ps.constantBuffersToUpdate.size() == 0 && commandListData.vs.constantBuffersToUpdate.size() == 0 &&
         commandListData.cs.constantBuffersToUpdate.size() == 0)) {
        return;
    }
...
void ConstantHandlerBase::ApplyConstantValues(effect_runtime* runtime,
